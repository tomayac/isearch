...
com.isearch.results.fetch = function(query) {
  ...
  //Options object. Should we put it in users profiles?
  var options = {
      maxres: 100, 
      clusters0: 5,
      clusters1: 3, 
      trans: "lle" //Can be "lle" or "rand"
  };    

  //Query constitution
  var queryObject = { 
      "q": query, 
      "total": options.maxres, 
      "cls": options.clusters0 + ',' + options.clusters1, 
      "tr": options.trans 
  } ;
  ...
  $.ajax({
    ...
    success: function(data, textStatus, jqXHR) {
      ...
      if (com.isearch.flashResults) {
        ...
        window.setTimeout(com.isearch.results.visualize, 1000);
      } else {
