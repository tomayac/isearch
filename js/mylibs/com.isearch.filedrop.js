        ...
        for (var i=0, l=files.length; i<l; i++) {
            ...
            */
            if (typeof FileReader !== "undefined") {
            	...
            	if((/image/i).test(files[i].type) && (jQuery.inArray('jpg',this.accept) || jQuery.inArray('png',this.accept))) {
            		acceptFile = true;
            	...
            	if(((/dae/i).test(files[i].name) && jQuery.inArray('dae',this.accept)) || 
            	   ((/zip/i).test(files[i].name) && jQuery.inArray('zip',this.accept))) {
            		acceptFile = true;
