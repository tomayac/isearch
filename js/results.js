...
$(function()	{ 
	...
	$('#search-form #show-less').click( function() {
			showLess() ;
	}) ;
	...
	swfobject.embedSWF( "demo.swf", "swf", "100%", "600", "10.2.0", "playerProductInstall.swf", flashVars, params, attrs, outputStatus );
        
    $('a#show-help').live('click', function() {
    	var url = "help.html";
    	var dialog = $('<div id="help-dialog" style="display:hidden"></div>').appendTo('body');
    	...
    	dialog.load(
            ...
            function(responseText, textStatus, XMLHttpRequest) {
                dialog.dialog({modal: true, width: 600, height: 400, title: "Help"});
            }
        );
	...
	$('#visualisation-method').change(function() {
		if ( swfObj && lastResult )
			swfObj.visualiseResults(lastResult, $("#visualisation-method").val(), { "iconSize": $("#icon-size").val() }) ;
	});
