...
$(function()	{ 
	...
	var attrs = {} ;
	swfobject.embedSWF( "demo.swf", "swf", 
                      "100%", "600", 
	...
	$('#visualization-method').change(function() {
		if ( swfObj && lastResult )
			swfObj.visualiseResults(lastResult, $("#visualization-method").val(), { "iconSize": $("#icon-size").val() }) ;
	});
	...
	$( "#query-submit").click(function (e) {
		...
		var keywords = $("#query-field").val() ;
		if (keywords == '') {
		  alert('no query in here!');	
			return ;
		}
    ...
    //Options
		...
		var clusters0 = 5 ;
		var clusters1 = 3 ;
		var trans = "lle"; //Can be "lle" or "rand" => put that in user prefs?
