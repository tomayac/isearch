function localConfig(data)
{
	...
	data.visOptions.filterBar.modalities =  { "image": { label: "Images"}, "audio": { label: "Audio Files" }  }
	data.fileUploadServer = "http://vision.iti.gr/sotiris/isearch/debug/upload.php" ;
	data.queryFormulatorUrl = "http://vision.iti.gr/sotiris/isearch/debug/mqf.php?index=uc1" ;
