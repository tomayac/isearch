function SmileySlider(container, imgSrc) {
  ...
  function drawSmile(context, mainRadius, offsetY, innerScale, emotion) {
    ...
    drawArc(context, mainRadius, offsetY, innerScale, emotion, curveOffset,
        true);
  }
  ...
  function drawArc(context, mainRadius, offsetY, innerScale, emotion,
        curveOffset, reverseX) {
    ...
    ct[0][1] = innerRadius * Math.sin((theta * 3) * PI180) * emoScale + offsetY
        + pad - (curveOffset * mainRadius);
    
    ct[1][0] = innerRadius * Math.cos((theta * 5) * PI180) + pad +
        (innerRadius * 2);
    ct[1][1] = innerRadius * Math.sin((theta * 5) * PI180) * emoScale +
        offsetY + pad - (curveOffset * mainRadius);
    ...
    context.bezierCurveTo(ct[0][0], ct[0][1], ct[1][0], ct[1][1], sides[1],
        offsetY + pad);
  }
