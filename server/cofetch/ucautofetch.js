	...
	var job = new nodeio.Job(options, {
	    input: function (start, num, callback) {
			...
			if(start < clusters.length) {
				...
				console.log(" ");
				console.log("-------------------------------------------------------------------------");
				console.log("Initialized all query clusters for fetching data!");
				console.log("-------------------------------------------------------------------------");
